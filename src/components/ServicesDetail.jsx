    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6" style={{ fontFamily: "'Oswald', sans-serif", fontWeight: 700, color: '#1F2937' }}>
            THE SERVICES WE DELIVER WITH<br />DISTINCTION
          </h2>
          <p className="text-gray-600 max-w-4xl mx-auto text-lg" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div
              ...
              className="bg-white rounded-3xl p-8 transition-shadow duration-300 cursor-pointer"
            ...
            >
              ...
              {/* Title */}
              <h3 className="text-xl font-bold mb-4 text-center" style={{ fontFamily: "'Oswald', sans-serif", fontWeight: 600, color: '#1F2937' }}>
                {service.title}
              </h3>

              {/* Description */}
              <p className="text-center text-gray-700 leading-relaxed" style={{ fontFamily: "'Poppins', sans-serif", fontSize: '15px' }}>
                {service.description}
              </p>
            </div>
          ))}
