      ...
      <div className="flex-1 flex items-center w-full overflow-hidden px-4 md:px-8 pt-3 pb-6 md:pb-8">
        <div className="rounded-2xl md:rounded-3xl overflow-hidden w-full h-full" style={{ backgroundColor: '#2A2B2D' }}>
          <div className="grid lg:grid-cols-2 gap-2 md:gap-6 p-6 md:p-12 lg:p-20 h-186">
            ...
            <div className="text-white flex flex-col justify-between h-full py-2 md:py-4">
              <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight tracking-tight mb-3 md:mb-4" style={{ fontFamily: "'Oswald', sans-serif", fontWeight: 600 }}>
                  <span className="block">OUR SECURITY</span>
                  <span className="block">SERVICES</span>
                </h2>
                <p className="text-base md:text-lg lg:text-xl text-gray-300 max-w-xl">
                  Unmatched expertise, elite training, and unwavering commitment—security that sets you free to focus on what matters.
                </p>
              </div>
            ...
            <div className="hidden lg:flex relative items-end pt-4" style={{ height: 'calc(100% + 5rem)', marginBottom: '-3rem', marginLeft: '-2rem', marginTop: '3rem' }}>
              ...
              <div className="absolute flex flex-col gap-5 z-20 animate-fade-in-right" style={{ right: '-0.5rem', top: '3rem', fontFamily: "'Oswald', sans-serif", animationDelay: '0.7s' }}>
            ...
            <div className="lg:hidden flex flex-row items-center justify-center gap-4">
              ...
              <div className="relative" style={{ width: '180px', height: '330px' }}>
                ...
                <img
                  src="/guard_hero.png"
                  alt="Security Guard"
                  className="absolute -bottom-[125px] left-1/2 -translate-x-1/2 h-[550px] w-auto object-contain"
                />
              </div>

              {/* Mobile Badges - Stacked vertically on right */}
              <div className="flex flex-col gap-2.5 w-[120px] mt-[-58]">
