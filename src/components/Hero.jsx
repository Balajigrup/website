          ...
          <div className="grid lg:grid-cols-2 gap-2 md:gap-6 p-6 md:p-12 lg:p-20 h-186">
            ...
            <div className="text-white flex flex-col justify-between h-full py-2 md:py-4">
              <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <h2 className="text-[1.85rem] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight tracking-tight mb-2 md:mb-4" style={{ fontFamily: "'Oswald', sans-serif", fontWeight: 600 }}>
                  <span className="block">PROTECTING PEOPLE</span>
                  <span className="block">& PLACES WITH EXCELLENCE</span>
                </h2>
            ...
            <div className="lg:hidden flex flex-row items-center justify-center gap-4">
              {/* Mobile Guard Image */}
              <div className="relative" style={{ width: '180px', height: '330px', marginTop: '3rem' }}>
                {/* Blue background */}
                <div
